...
class LoginScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(create:(context)=> LoginSignUpCubit(),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        obscureText: LoginSignUpCubit.get(context).isVisible,
                        ...
                        decoration: InputDecoration(
                            ...
                            suffix: IconButton(onPressed: () {
                              LoginSignUpCubit.get(context).changeVisibility();
                            },
                              splashColor: HexColor("#6823D0"),
                              alignment: AlignmentDirectional.center,
                              icon: Icon(LoginSignUpCubit.get(context).iconPassword),
                            ),
                            hintText: 'Password',
                            hintStyle:Theme.of(context).textTheme.subtitle2,
                            border:const OutlineInputBorder() ,
