...
class FriendsScreen extends StatelessWidget {
  ...
  Widget buildFriendRequests(context_1, FriendsRequestModule request) =>
      ConditionalBuilder(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: MaterialButton(
                                  elevation: 5,
                                  onPressed: () {
                                    PurpleBookCubit.get(context_1).acceptFriendRequest(id: request.friendRequests![index].user!.sId!);
                                  },
        ...
        fallback: (context_1)=>const Text('Wow, such empty ⚆_⚆',style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold),),
      );
                  ...
                  child: Padding(
                      ...
                      child: Row(
                        children: [
                            ...
                            child: InkWell(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if(request.friendRecommendation![index].mutualFriends!=0)
                                  Text(
                          ...
                          if(request.friendRecommendation![index].friendState=='NOT_FRIEND')
                          Expanded(
                            child: MaterialButton(
                              onPressed: () {
                                PurpleBookCubit.get(context_1).sendRequestFriend(id: request.friendRecommendation![index].sId!).then((value) {
                                  PurpleBookCubit.get(context_1).getFriendRecommendation();
                                });
                              },
                              color: HexColor("#6823D0"),
                              child: const Text(
                          ...
                          else if(request.friendRecommendation![index].friendState=='FRIEND_REQUEST_SENT')
                            Expanded(
                              child: MaterialButton(
                                onPressed: () {
                                  PurpleBookCubit.get(context_1).cancelSendRequestFriend(receiveId: request.friendRecommendation![index].sId!).then((value) {
                                    PurpleBookCubit.get(context_1).getFriendRecommendation();
                                  });
                                },
                                color: Colors.grey,
                            ...
                            Expanded(
                              child: MaterialButton(
                                onPressed: () {
                                  PurpleBookCubit.get(context_1).acceptFriendRequest(id: request.friendRecommendation![index].sId!);},
                                color: Colors.grey,
                                child: const Text(
                                  'accept request',
                                  style: TextStyle(color: Colors.white),
