...
class ViewPostScreen extends StatelessWidget {
  ...
  ViewPostScreen({Key? key, required this.id, required this.count})
      : super(key: key);
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ConditionalBuilder(
                        condition: state is! ViewPostLoadingState &&
                            cubit.isLikePost!.isNotEmpty,
                                                ...
                                                IconButton(
                                                  onPressed: () {
                                                    cubit.likePost(
                                                        ...
                                                        index: count);
                                                    cubit
                                                        .changeColorIcon(count);
                                                  },
                                                  icon: const Icon(Icons
                                                      .thumb_up_alt_outlined),
                                                  color: PurpleBookCubit.get(
                                                              context)
                                                          .isLikePost![count]
                                                      ? HexColor("#6823D0")
                                                      : Colors.grey,
